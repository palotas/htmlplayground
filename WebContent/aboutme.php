...
<meta name="description" content="Gridfusion - Test Automation Consulting" />
<meta name="keywords" content="Michael Palotas, test consulting, selenium consulting, head of quality engineering, java, page objects, open source, 
...
<div id="container">
	...
	<div id="content">		
		...
		<div class="maincontainer">
			...
			<p>
				Michael had a direct influence on Selenium Grid, which was developed and open sourced within his team at eBay.  
				Selenium Grid has become a standard component of the most popular open source browser automation framework.
			</p>
			<p>	
				Next to expert knowledge in test automation, GRIDFUSION also has a strong network of partners for implementing full scale solutions and providing related services. 
			</p>			
		</div>
